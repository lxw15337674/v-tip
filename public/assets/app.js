...
(function () {
  ...
  (function (global, factory) {
      ...
      ***************************************************************************** */
      ...
      var script = {
        ...
        computed: {
          tipStyle: function tipStyle() {
            return {
              transform: "translate3d(".concat(this.position.left, "px, ").concat(this.position.top, "px,0px)")
            };
          },
          tipClass: function tipClass() {
            var classList = [this.theme];

            if (['right', 'left', 'top', 'bottom'].indexOf(this.positions) !== -1) {
              classList.push("".concat(this.positions, "-tip"));
            }
        ...
        methods: {
          ...
          unBindEvent: function unBindEvent(triggers) {
          ...
          tooltipToggle: function tooltipToggle(event) {
            var _this = this;
          ...
          handlerHover: function handlerHover(event) {
            var _this2 = this;
            ...
            this._scheduleTimer = window.setTimeout(function () {
              ...
              _this2.$nextTick().then(function () {
                return _this2.setPosition(event);
              });
            }, this.delay);
          },
      ...
      var __vue_render__ = function() {
        ...
        var _h = _vm.$createElement;
        var _c = _vm._self._c || _h;
        return _c("transition", { attrs: { name: "v-tip-fade" } }, [
          _c(
            "div",
            {
              directives: [
      ...
      __vue_render__._withStripped = true;
        ...
        /* scoped */
        const __vue_scope_id__ = "data-v-ce87551c";
        /* module identifier */
        const __vue_module_identifier__ = undefined;
        /* functional template */
        const __vue_is_functional_template__ = false;
      ...
      var Tooltip = (function () {
          function Tooltip(el, vnode, options) {
              ...
              var tipConstruct = Vue.extend(__vue_component__);
  ...
  var tip = /*@__PURE__*/unwrapExports(dist);
